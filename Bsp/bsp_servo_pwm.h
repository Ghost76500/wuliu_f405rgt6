...
#define GIMBAL_INIT_ANGLE 1980 // 初始位置占空比(未定义,随便填一个数字)
...
#define GIMBAL_GREEN_ANGLE 965
#define GIMBAL_RED_ANGLE 665

#define GIMBAL_NAWULIAO_ANGLE 965


/*夹爪指定状态宏定义*/
#define JIAZHUA_INIT 500   // 夹爪初始状态占空比(未定义,随便填一个数字)
#define JIAZHUA_CLOSE 500   // 夹爪闭合占空比(未定义,随便填一个数字)
#define JIAZHUA_XIAO_OPEN 580   // 夹爪张开一点点占空比(未定义,随便填一个数字)
#define JIAZHUA_DA_OPEN 650   // 夹爪完全张开占空比
...
extern void bsp_gimbal_turn(uint16_t target_duty, uint16_t step_delay_ms);
